<div class="relative min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 bg-slate-950 overflow-hidden z-0">
    ...
    <!-- Login Container -->
    <div class="relative z-10 w-full max-w-[440px] bg-white/5 dark:bg-black/20 backdrop-blur-xl border border-white/10 dark:border-white/5 px-6 py-10 md:p-10 rounded-3xl shadow-2xl flex flex-col items-center">
        <!-- Logo and Heading -->
    ...
    <style>
        /* Make default Filament simple layout containers transparent */
        .fi-simple-layout {
        ...
        /* Form labels styling */
        .fi-fo-field-wrp-label label span {
