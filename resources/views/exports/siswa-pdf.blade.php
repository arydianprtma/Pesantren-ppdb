...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        thead th { padding: 8px 6px; text-align: left; font-size: 10px; font-weight: 700; border: 1px solid #000; color: #fff !important; }
        tbody tr:nth-child(even) { background: #f5f5f5; }
        tbody td { padding: 7px 6px; border: 1px solid #bbb; font-size: 10px; }
...
<div class="kop">
    <img src="/logo_pondok.png" alt="Logo Pesantren" onerror="this.src='/Logo Riyad.png'; this.onerror=function(){this.style.display='none';}">
    <div class="kop-text">
        <h1>PONDOK PESANTREN RIYADUSSALIKIN PADAHERANG</h1>
        <p>Jl. Raya Padaherang, Kab. Pangandaran, Jawa Barat</p>
        <p>Data Pendaftar / Santri Terdaftar</p>
    </div>
...
<table>
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="5" style="text-align:center; padding:20px; color:#666;">Tidak ada data siswa / santri.</td>
            </tr>
        @endforelse
    </tbody>
</table>
