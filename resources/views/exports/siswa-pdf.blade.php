...
<div class="page-container">
    ...
    {{-- ── Kop Surat ── --}}
    <div class="kop">
        <img src="/Logo Riyad.png" alt="Logo Pesantren" onerror="this.src='/logo_pondok.png'; this.onerror=function(){this.style.display='none';}">
        <div class="kop-text">
            <h1>Pondok Pesantren Riyadussalikin Padaherang</h1>
            <p class="alamat">Jl. Raya Padaherang, Kab. Pangandaran, Jawa Barat</p>
            <p class="sub">Data Santri / Siswa Terdaftar</p>
        </div>
    ...
    {{-- ── Meta Info ── --}}
    <div class="meta-card">
        <div class="meta-item"><strong>Total Data:</strong> {{ count($data) }} santri</div>
            ...
            @empty
                <tr>
                    <td colspan="5" style="text-align:center; padding:24px; color:#94a3b8; font-style:italic;">
                        Tidak ada data siswa / santri yang dapat ditampilkan.
                    </td>
                </tr>
            @endforelse
        </tbody>
