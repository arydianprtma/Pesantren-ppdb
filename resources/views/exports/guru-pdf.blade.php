    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        thead th {
            ...
            font-size: 9px; font-weight: 700; border: 1px solid #000;
            text-transform: uppercase;
        ...
        tbody td { padding: 4px; border: 1px solid #999; font-size: 9.5px; }
...
<div class="meta">
    <span>Total: <strong>{{ count($data) }}</strong> guru</span>
...
<table>
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="9" style="text-align:center; padding:20px; color:#666; font-style:italic;">Tidak ada data guru.</td>
            </tr>
        @endforelse
    </tbody>
</table>
