        ...
        <section class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <!-- Left: Text Content -->
                    <div>
                        <span class="text-emerald-600 font-bold uppercase tracking-widest text-sm mb-3 block">Mengenal Kami</span>
                        <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-6 leading-tight">
                            Pondok Pesantren <span class="text-emerald-600">Riyadussalikin</span> Padaherang
                        </h2>
                        ...
                        <Link :href="route('tentang-pondok')" class="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25">
                            Selengkapnya
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        <div class="flex items-start gap-4 p-5 rounded-2xl bg-emerald-50 border border-emerald-100 hover:border-emerald-300 transition-all duration-300">
                            <div class="bg-emerald-600 w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm leading-relaxed">Kurikulum terpadu yang menggabungkan pendidikan agama dan umum dengan metode pembelajaran modern.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-5 rounded-2xl bg-emerald-50 border border-emerald-100 hover:border-emerald-300 transition-all duration-300">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-1">Pembinaan Akhlak</h3>
                                <p class="text-gray-500 text-sm leading-relaxed">Fokus pada pembentukan karakter islami yang kuat melalui bimbingan ustadz dan ustadzah yang berpengalaman.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-5 rounded-2xl bg-emerald-50 border border-emerald-100 hover:border-emerald-300 transition-all duration-300">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-1">Fasilitas Lengkap</h3>
                                <p class="text-gray-500 text-sm leading-relaxed">Asrama nyaman, masjid luas, perpustakaan, laboratorium, dan fasilitas olahraga yang memadai.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center gap-2">
                                ...
                                >
                                    {{ agenda.kategori === 'ppdb' ? 'SPMB' : agenda.kategori === 'akademik' ? 'Akademik' : 'Kegiatan' }}
                                </span>
                            </div>
